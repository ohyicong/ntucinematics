<?php
	...
	if((int)$var["maxTime"]!=0){
		...
		for ($i=1;$i<8;$i++){
			$query="INSERT INTO `loc_address`(`MOVIE_ID`, `MOVIE_NAME`, `CINEMA_ID`, `CINEMA`, `DAY`, `TIME`, `TIMESTAMP`, `UNIQUE_ID`) VALUES ('".$movieID."','".$movieNameDB[$movieID-1]."','".$cinemaID."','".$cinemaNameDB[$cinemaID-1]."','00".$i."','"."001"."','".$timestamp."'".",'".$movieID.$cinemaID."00".$i."00".((int)$var["maxTime"]+1)."')";
			$conn->query($query);
			echo $query;
		}
